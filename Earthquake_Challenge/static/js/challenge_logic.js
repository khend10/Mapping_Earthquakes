...
//Create a third tile layer that (Deliverable 3)
...
// Create a base layer that holds all three maps (Deliverable 3)
let baseMaps = {
  "Streets": streets,
  "Satellite": satelliteStreets
};

// 1. Add a 2nd layer group for the tectonic plate data. (Deliverable 1 & 2)
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();

// 2. Add a reference to the tectonic plates group to the overlays object. (Deliverable 1 & 2)
let overlays = {
